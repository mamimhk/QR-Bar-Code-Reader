    ...
    public partial class MainWindow : Window
    {
        ...
        void onOff()
        {
            if (!showFrames)
            {
                ...
                StartStopButton.Background = new SolidColorBrush(System.Windows.Media.Color.FromRgb(180, 190, 53));
            ...
            else
            {
                ...
                StartStopButton.Background = new SolidColorBrush(System.Windows.Media.Color.FromRgb(230, 220, 0));
                showFrames = !showFrames;
                videoDevice.NewFrame -= VideoDevice_NewFrame;
